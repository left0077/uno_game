...
import { GameStateV2, GameActionV2, calculateResult } from '../game/v2/types.js';
import { PlayerManager } from '../game/v2/PlayerManager.js';
import { GameInitializer } from '../game/v2/GameInitializer.js';
import { BaseGameModeV2 } from '../game/v2/BaseGameModeV2.js';
...
export function setupSocketHandlersV2(io: Server): void {
