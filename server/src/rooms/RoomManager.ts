...
export class RoomManager {
  ...
  addAI(roomCode: string, difficulty: 'easy' | 'normal' | 'hard', aiType: 'bot' | 'host' = 'bot'): Player | null {
    ...
    // AI 昵称池 — 新抽象美学
    const botNames = [
      '电子蝴蝶', '液态梦境', '凌晨三点半', '404号情绪',
      '赛博观音', '蓝色药丸批发', '过期罐头', '速溶乡愁',
      '塑料樱花', '人工降雨', '二手玫瑰', '打折灵魂',
      '空气炸锅', '深夜泡面', '虚拟碳水', '数字咸鱼',
      '静止心跳', '溶解计划', '褪色滤镜', '低像素月亮',
      '耳鸣时刻', '长期离线', '电量不足', '信号塔上的猫',
      '被删除的夏天', '一个没有ID的人', '银河系前台', '宇宙级路人',
      '不完整切片', '延迟满足', '悲观主义蛋糕', '无糖浪漫',
      '野生代码', '沉默警报', '漂浮物', '未读消息',
      '压缩饼干', '速冻黄昏', '折叠椅哲学家', '最后一格电',
      '空白头像', '系统默认昵称', '正在输入中', '对方已读不回',
    ];
    const hostNames = [
      '已离开对话框', '正在发呆', '呼吸暂停中', '瞳孔失焦',
      '咖啡因半衰期', '被重力捕获', '信号微弱',
      '短暂失联', '去给手机充电了', '梦里出牌',
    ];
